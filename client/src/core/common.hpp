...
format::string const user_info_uri          = "http://spchat.ru/login.php?c=info&ni={0}";
format::string const forum_post_uri         = "http://forum.spchat.ru/viewtopic.php?p={0}#p{0}";

format::string const photoalbum_thumb_uri   = "http://photo.spchat.ru/img/pre/{0}";
format::string const photoalbum_photo_uri   = "http://photo.spchat.ru/index.php?a=view&n={0}";

format::string const email_uri              = "mailto:{0}";
format::string const vkontakte_uri          = "http://vk.com/id{0}";
format::string const icq_uri                = "http://www.icq.com/people/{0}";
